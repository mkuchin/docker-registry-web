...
<div class="row">
    <div class="col-md-12">
        ...
        <div class="page-header"><h1>Role: ${role.authority}</h1></div>
        <h4>Acess control list</h4>
        <table class="table-bordered table table-hover">
            <tr><th>IP</th><th>Repository</th><th>Permissions</th><th>Comments</th><th>Action</th></tr>
            <g:each in="${acls}" var="acl">
                <tr>
                    ...
                    <td>${acl.comment}</td>
                    <td><g:link class="btn btn-default" action="deleteAcl" id="${acl.id}"
                                params="[roleId: role.id]">x</g:link></td>
                </tr>
            </g:each>
            <g:form action="addAcl">
                ...
                <tr>
                    ...
                    <td><g:submitButton name="Add" class="btn btn-default"/></td>
                </tr>
            </g:form>
        </table>
    </div>
